...
class Mohsen_Tello():
    ...
    def __init__(self):
        ...
        EmergencyThread = Thread(target=self.Emergencystop)
    ...
    def Keyboard_Control(self):
        ...
        keyboard.add_hotkey("f+q",flip_backleft)
        keyboard.add_hotkey("f+e",flip_backright)
        keyboard.add_hotkey("f+z",flip_forwardleft)
        keyboard.add_hotkey("f+c",flip_forwardright)
