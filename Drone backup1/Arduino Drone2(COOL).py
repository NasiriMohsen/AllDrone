...
#########################################################################
    if tspeed == 0:
        ...
        arduino.Servos.writeMicroseconds(m1, speeder(tspeed + speed1 - pidx + pidy,out_min=min1,out_max=max1))
        arduino.Servos.writeMicroseconds(m2, speeder(tspeed + speed2 - pidx - pidy,out_min=min2,out_max=max2))
        arduino.Servos.writeMicroseconds(m3, speeder(tspeed + speed3 + pidx - pidy,out_min=min3,out_max=max3))
        arduino.Servos.writeMicroseconds(m4, speeder(tspeed + speed4 + pidx + pidy,out_min=min4,out_max=max4))
